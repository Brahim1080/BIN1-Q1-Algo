...
public class Multiplication1{
	...
	public static int faireUneMultiplication(int valeurMinimale, int valeurMaximale) {
		int multiplication= (unEntierAuHasardEntre(valeurMinimale,valeurMaximale))*(unEntierAuHasardEntre(valeurMinimale,valeurMaximale));
