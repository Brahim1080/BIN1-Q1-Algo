...
public class TriParSelection {
	...
	/**
	 * Renvoie une nouvelle table triee à partir du tableau t.
	...
	public static int[] tri (int[] t) {
		...
		int [] tableTrie = new int[t.length];
		for (int i = 0; i <t.length; i++) {
			tableTrie[i]= t[i];
		}
	...
	/**
	 * Renvoie une table de taille 5 contenant les 5 plus petits éléments de t.
	 * Si la table t contient moins de 5 éléments, la taille de la
	 * table renvoyée sera égale à la taille de t.
	 * @param t
	 * @return une table contenant les 5 plus petits éléments de t
	 */
